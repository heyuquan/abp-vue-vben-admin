...
namespace Mk.DemoB.Web.Menus
{
    public class DemoBMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public DemoBMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<DemoBResource>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem("DemoB.Home", l["Menu:Home"], "~/"));
