...
namespace System
{
    ...
    public static class TypeExtensions
    {
        ...
        {
            Checked.NotNull(type, nameof(type));
            Checked.NotNull(baseType, nameof(baseType));
        ...
        {
            Checked.NotNull(genericType, "genericType");
            Checked.NotNull(genericType, "type");
        ...
        {
            Checked.NotNull(assembly, nameof(assembly));
