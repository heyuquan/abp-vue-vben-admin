...
namespace System
{
    ...
    public static partial class StringExtentions
    {
        ...
        {
            return !source.IsNullOrEmpty2() && Regex.IsMatch(source, pattern);
        }
        ...
        {
            string result = source.IsNullOrEmpty2() ? "" : Regex.Match(source, pattern).Value;
            return result;
        }
        ...
        {
            return !checkStr.IsNullOrEmpty2() && Regex.IsMatch(checkStr, @"[a-zA-z]+://[^s]*", RegexOptions.Compiled);
        }
