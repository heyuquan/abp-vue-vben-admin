...
namespace EShop.Account.Public.Emailing.Templates
{
	public class AccountEmailTemplateDefinitionProvider : TemplateDefinitionProvider
	{
		public override void Define(ITemplateDefinitionContext context)
		{
			...
			int num = 0;
			string name = AccountEmailTemplates.PasswordResetLink;
			var displayName = LocalizableString.Create<EShopAccountResource>($"TextTemplate:{AccountEmailTemplates.PasswordResetLink}");
			...
			int num2 = 0;
			string name2 = AccountEmailTemplates.EmailConfirmationLink;
			displayName = LocalizableString.Create<EShopAccountResource>($"TextTemplate:{AccountEmailTemplates.EmailConfirmationLink}");
