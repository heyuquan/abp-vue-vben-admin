...
namespace EShop.Account.Public.Emailing
{
    public class AccountEmailer : IAccountEmailer, ITransientDependency
	{
		...
		protected IStringLocalizer<EShopAccountResource> StringLocalizer { get; }

		protected IAppUrlProvider AppUrlProvider { get; }

		protected ICurrentTenant CurrentTenant { get; }

		public AccountEmailer(IEmailSender emailSender, ITemplateRenderer templateRenderer, IStringLocalizer<EShopAccountResource> stringLocalizer, IAppUrlProvider appUrlProvider, ICurrentTenant currentTenant)
		{
