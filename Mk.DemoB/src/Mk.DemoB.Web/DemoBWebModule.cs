...
namespace Mk.DemoB.Web
{
    ...
    public class DemoBWebModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(DemoBResource),
                    typeof(DemoBDomainSharedModule).Assembly,
                    typeof(DemoBApplicationContractsModule).Assembly,
                    typeof(DemoBWebModule).Assembly
                );
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<DemoBWebModule>();
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<DemoBDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Mk.DemoB.Domain"));
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<DemoBWebModule>(hostingEnvironment.ContentRootPath);
                });
            }
        }
        ...
        private void ConfigureNavigationServices(IConfiguration configuration)
        {
            ...
            {
                options.MenuContributors.Add(new DemoBMenuContributor(configuration));
            });
        }
