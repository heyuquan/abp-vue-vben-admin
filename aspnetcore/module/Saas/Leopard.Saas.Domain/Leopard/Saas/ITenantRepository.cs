...
{
    public interface ITenantRepository : IReadOnlyRepository<Tenant, Guid>, IReadOnlyBasicRepository<Tenant>, IBasicRepository<Tenant>, IBasicRepository<Tenant, Guid>, IRepository
    {
