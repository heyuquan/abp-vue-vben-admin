...
namespace Leopard.BackendAdmin
{
    ...
    public class BackendAdminHttpApiHostModule : AbpModule
    {
        ...
        {
            Configure<AbpDistributedCacheOptions>(options => { options.KeyPrefix = "BackendAdmin:"; });
        }
        ...
        private void ConfigureConventionalControllers()
        {
            ...
            {
                options.ConventionalControllers.Create(typeof(BackendAdminApplicationModule).Assembly);
            });
        }
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "BackendAdmin API");

                var configuration = context.GetConfiguration();
                options.OAuthClientId(configuration["AuthServer:SwaggerClientId"]);
                options.OAuthClientSecret(configuration["AuthServer:SwaggerClientSecret"]);
                options.OAuthScopes("BackendAdmin");
            });
